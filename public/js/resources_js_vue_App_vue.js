  ...
  return _c("div", { staticStyle: { "background-color": "transparent" } }, [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("PaginationBar", {
          attrs: { nations: _vm.nations, types: _vm.types, tiers: _vm.tiers },
  ...
  return _c("div", { staticClass: "row main-container" }, [
              ...
              return _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass: "page-link pagination-link",
                      class: { active: _vm.checkState("tiers", tierName) },
                      attrs: { href: "#" },
                      on: {
                        click: function ($event) {
                          return _vm.toggleState("tiers", tierName)
                        },
                      },
                    },
                    [
    ...
    _c("div", { staticClass: "col-3" }, [
      _c(
        "button",
        {
          staticClass: "btn btn-success rounded clear-all-button",
          on: {
            click: function ($event) {
              return _vm.clearAll()
            },
  ...
  function () {
    ...
    return _c("li", { staticClass: "page-item pagination-list-element" }, [
      _c(
        "a",
        {
          staticClass: "page-link pagination-link inactive-pagination-link",
          attrs: { href: "#" },
        },
        [_vm._v("Tier:")]
      ),
